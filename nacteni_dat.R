...
## ulozeni csvcek pro nahrani na superset

write.csv(data, "~\\bo_data_analysis\\apache_superset\\hodinova_data.csv", row.names = FALSE)
write.csv(data_denni, "~\\bo_data_analysis\\apache_superset\\denni_data.csv", row.names = FALSE)
