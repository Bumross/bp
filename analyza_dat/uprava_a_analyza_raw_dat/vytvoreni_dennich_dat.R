...
### je lepsi uvazovat bez posledni hodnoty - tam je jen zacatek dne 
data_denni_bez_posledniho <- data_denni[-nrow(data_denni), ]

# Nové shrnutí
summary(data_denni_bez_posledniho)
saveRDS(data_denni_bez_posledniho, file = "~\\bo_data_analysis\\data\\data_procesovane\\data_denni.rds")
